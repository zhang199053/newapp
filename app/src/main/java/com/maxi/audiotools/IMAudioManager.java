...
public class IMAudioManager {
    ...
    public void playSound(String voicePath,
                          MediaPlayer.OnCompletionListener onCompletionListener, final AudioPlayCallBack audioPlayCallBack) {
        ...
        try {
            ...
            e.printStackTrace();
            audioPlayCallBack.playError(e.getMessage());
        }
    }

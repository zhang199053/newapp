...
public class FilterPopupButton extends AppCompatButton implements PopupWindow.OnDismissListener {
    ...
    private void init(int i) {
        ...
        if (i==1){
            mRvChild.setVisibility(GONE);
        }else {
            mRvChild.setVisibility(VISIBLE);
        }
        ...
        mParentAdapter.setOnItemClickListener(new MultiItemTypeAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, RecyclerView.ViewHolder holder, int position) {
                if (position == 0) {
                    ...
                    if (mParentList.get(position).equals("不限")){
        ...
        this.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (mFixPopupWindow == null) {
                    ...
                    LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, (int) (mScreenHeight * 0.3));
